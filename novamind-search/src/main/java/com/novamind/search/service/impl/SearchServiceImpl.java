...
import com.novamind.search.config.InterestsProperties;
...
import com.novamind.search.service.IInterestsService;
import com.novamind.search.service.ISearchService;
...
import static com.novamind.search.repository.CourseRepository.PUBLISH_TIME;
...
public class SearchServiceImpl implements ISearchService {
    ...
    private List<CourseVO> queryTopNCourseOnMarketByFree(boolean isFree, String sortBy) {
        int topN = interestsProperties.getTopNumber();
        if (topN <= 0) {
            topN = 10;
        }
        ...
        if (id == null) {
            ...
            if (CollUtils.isEmpty(categoryIds)) {
                ...
                courses = queryTopNByCategoryIdLv2sAndFree(
                        categoryIds, isFree, sortBy, false, topN);
            }
        }
        return courses;
    }
