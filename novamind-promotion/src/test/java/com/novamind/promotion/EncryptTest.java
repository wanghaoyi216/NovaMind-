package com.novamind.promotion;

import cn.hutool.core.util.ArrayUtil;
import cn.hutool.crypto.SecureUtil;
import cn.hutool.crypto.digest.HMac;
import com.novamind.common.exceptions.BadRequestException;
import com.novamind.promotion.utils.AESUtil;
import com.novamind.promotion.utils.Base32;
import com.novamind.promotion.utils.BitConverter;
...
public class EncryptTest {
    ...
    private AESUtil aesUtil = new AESUtil("novamind-test-key-in", "novamind-test-ivinit");
    @Test
    ...
    // @Test
    // void testCodeUtil() {
    //     CodeUtil codeUtil = new CodeUtil(new AESUtil("novamind-test-key-in", "novamind-test-ivinit"));
    //
