package com.novamind.trade.handler;
...
public class PayMessageHandler {
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(name = "trade.order.query.queue", durable = "true"),
            exchange = @Exchange(name = MqConstants.Exchange.TRADE_DELAY_EXCHANGE, type = ExchangeTypes.TOPIC),
