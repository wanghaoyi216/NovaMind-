...
public interface Agent {
     ...
     */
    default Flux<ChatEventVO> processStream(String question, String sessionId) {
        return processStream(question, sessionId, cn.hutool.core.util.IdUtil.fastSimpleUUID());
    }
     ...
     * @param question  用户输入的问题
     * @param sessionId 会话唯一标识
     * @param requestId 贯穿整个请求和工具调用的请求ID
     * @return 包含中间结果的反应式事件流（Flux）
     */
    Flux<ChatEventVO> processStream(String question, String sessionId, String requestId);
