package com.novamind.aigc.tools;
...
import com.novamind.aigc.tools.result.PrePlaceOrder;
...
public class OrderTools {
    ...
    public PrePlaceOrder prePlaceOrder(@ToolParam(description = Constant.ToolParams.COURSE_IDS) List<Number> courseIds,
        ...
        SecurityContextHolder.getContext().setAuthentication(new TjAuthenticationToken(userId, null));
        try {
            // 调用预下单接口
